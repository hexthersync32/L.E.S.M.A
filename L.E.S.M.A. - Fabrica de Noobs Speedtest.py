...
def shell():
	...
	printer('Obtendo a configuração do speedtest.net...', quiet)
	try:
		speedtest = Speedtest()
	...
	if not args.mini:
		printer('Obtendo lista de servidores em speedtest.net...', quiet)
		try:
		...
		printer('Selecinando melhor servidor com base no ping...', quiet)
...
def main():
	...
	num = 0
	print (" ")
	print ("Relatório obtido com através do L.E.S.M.A")
	print ("Site oficial: https://github.com/NatanSkywalker/L.E.S.M.A")
	print (" ")
	while a==0:
